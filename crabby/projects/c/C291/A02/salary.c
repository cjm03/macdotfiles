...
int main() {
    ...
    double overtime_hours, hours_worked, credits, overload_credits, courses;
    
    // Administrator variables
    double ADM_AVG_SALARY = 0, ADM_AVG_PAY = 0;

    // Staff variables
    double STAFF_AVG_SALARY = 0, STAFF_OVERTIME_RATE = 0, STAFF_OT_HOURS = 0, STAFF_AVG_PAY = 0;
    
    // Hourly variables
    double HOURLY_AVG_SALARY = 0, HOURLY_HOURS_WORKED = 0, HOURLY_OVERTIME_RATE = 0, HOURLY_OT_HOURS = 0, HOURLY_AVG_PAY = 0;
    
    // Adjunct Faculty variables
    double ADJ_AVG_SALARY = 0, ADJ_AVG_PAY = 0;
    
    // Regular Faculty variables
    double REGF_AVG_SALARY = 0, REGF_AVG_PAY = 0;
    
    // TA variables
    double TA_HOURS_VALIDATION = 0, TA_BASE = 0, TA_ADJUSTED = 0, TA_OT_HOURS = 0, TA_OT_PAY = 0, TA_AVG_SALARY = 0, TA_AVG_PAY = 0;
...
// 'H' vars: HOURLY_AVG_SALARY, HOURLY_HOURS_WORKED, HOURLY_OVERTIME_RATE, HOURLY_OT_HOURS, HOURLY_AVG_PAY
		    ...
		    HOURLY_OT_HOURS = 20;
                    ...
                    HOURLY_OT_HOURS = hours_worked - 80;
                    HOURLY_AVG_PAY += (hourly_rate * 80) + (HOURLY_OVERTIME_RATE * HOURLY_OT_HOURS);
                } else {
                    HOURLY_AVG_PAY += hourly_rate * hours_worked;
                }
                HOURLY_COUNT++;
                break;
...
// 'R' vars: REGF_AVG_SALARY, REGF_AVG_PAY
            case 'R':
                ...
                REGF_AVG_PAY += (salary / 10) + ((2833.33 * overload_credits) / 5);
                REGF_COUNT++;
                break;
